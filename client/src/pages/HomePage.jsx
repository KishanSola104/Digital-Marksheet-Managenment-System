...
function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur border-b border-slate-200">
        <div className="max-w-7xl mx-auto h-20 px-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-bold text-slate-900 text-lg">DMMS</h2>
          ...
          <div className="hidden md:flex items-center gap-8">
            <a href="#about" className="text-slate-600 hover:text-blue-700">
              About
            </a>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            <p className="mt-8 text-lg text-slate-600 leading-8 max-w-xl">
              Simplify student record management, examinations, marksheets and
              academic reporting through one secure and centralized platform
            ...
            <div className="grid sm:grid-cols-2 gap-4 mt-14">
              <div className="flex items-center gap-3">
                ...
                <span className="text-slate-700">Secure Login</span>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-slate-700">Digital Marksheets</span>
              </div>

              <div className="flex items-center gap-3">
                <GraduationCap className="text-blue-700" size={22} />

                <span className="text-slate-700">Examination Management</span>
              </div>
            </div>
          </div>
      ...
      <section id="features" className="max-w-7xl mx-auto px-6 pb-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mt-14">
          <div className="bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-xl transition">
            ...
            <h3 className="mt-5 font-bold text-lg">Student Management</h3>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-xl transition">
            ...
            <h3 className="mt-5 font-bold text-lg">Digital Marksheets</h3>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-xl transition">
            ...
            <h3 className="mt-5 font-bold text-lg">Examination Module</h3>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-xl transition">
            <ShieldCheck className="text-blue-700" size={34} />

            <h3 className="mt-5 font-bold text-lg">Secure Access</h3>
      ...
      <footer id="about" className="border-t border-slate-200 py-8">
